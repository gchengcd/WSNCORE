...
/*	public void processMsg(IoSession session, WsnMsg msg) {
	...
	public void processMsg(IoSession session, WsnMsg msg) {
		...
		ArrayList<String> ret = 
				org.apache.servicemix.wsn.router.mgr.RtMgr.
				calForwardGroups(mns.topicName, mns.originatorGroup);
		...
		if (send && !mns.originatorAddr.equals(org.apache.servicemix.wsn.router.mgr.base.SysInfo.localAddr))// 本地有订阅并且不是消息产生者，则上交wsn。在这个地方不适合做多线程，全局变量，只读，也会出现问题
		{
